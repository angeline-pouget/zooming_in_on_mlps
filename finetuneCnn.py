...
import torch
from torch.nn import CrossEntropyLoss, Linear, Conv2d, Sequential
...
def finetune(args):
    ...
    crop_resolution, num_pretrain_classes = 64, 1000
    ...
    #change the conv1 to match the input
    num_ftrs = model.fc.in_features
    model.fc = Linear(num_ftrs, args.num_classes)
    model.conv1 = Conv2d(3,64, kernel_size=(3,3), stride=(1,1), padding=(1,1))
    model.maxpool = Sequential() 
...
if __name__ == "__main__":
    ...
    args.data_resolution = 64
    args.batch_size = 80
    args.epochs = 5
    args.lr = 0.01
    args.weigh_decay = 0.0001
    args.data_path = "C:\\mlp\\scaling_mlps\\beton"
    args.crop_scale = (0.4, 1)
    args.crop_ratio = (1.,1.)
